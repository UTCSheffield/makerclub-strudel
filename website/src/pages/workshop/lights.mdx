...
const {red, green, blue, hue, saturation, brightness, light, topic, blink}
= createParams('hue', 'saturation', 'brightness', 'light','topic','blink');
Pattern.prototype.lights = function() {return this.topic(name).mqtt('alpaca', undefined, undefined, 'wss://sponge.algorithmicpattern.org:443/mqtt')};
