...
Writing and changing code whilst it is running. 

In strudel we can change the music that is going to play without stopping it and starting again.
...
## You can prepare things first

It's possible to have code ready and then change it live, lot's of live-coders do this.

[Charli XCX – 360 (cover / remix)](https://strudel.cc/?2ErYTSUotoaQ) This song is a bit big to live remix 
but it can show you what is possible.
